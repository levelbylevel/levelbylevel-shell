...
==============
#TUTORIAL 
First make sure you have a gcc installed by running gcc --version.
If you dont install it with your package manager.
Then run ./simple-c-shell and enjoy your new shell.
If you want to exit it just quit the terminal instance.